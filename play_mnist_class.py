...
def run_experiment(args):
    ...
    eg.run(ddpg, num_cpu=args.cpu, data_dir=args.data_dir)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--exp_name', type=str, default='ddpg-custom3-50epochmeta')  # FIXME ddpg-custom, ddpg-custom2
